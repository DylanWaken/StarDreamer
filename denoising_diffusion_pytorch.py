...
This file is the diffusion model created by:
"Smith42" for the paper "Realistic galaxy simulation via score-based generative models"
...
class GaussianDiffusion(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        # calculations for diffusion.py q(x_t | x_{t-1}) and others
        ...
        # below: log calculation clipped because the posterior variance is 0 at the beginning of the diffusion.py chain
    ...
    def p_sample_loop(self, shape):
        ...
        # self.num_timesteps
        for i in tqdm(reversed(range(0, 1000)), desc='sampling loop time step', total=1000):
